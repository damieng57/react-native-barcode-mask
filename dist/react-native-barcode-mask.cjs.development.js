...
var fleetbackReactNativeCamera = require('fleetback-react-native-camera');
...
var BarcodeMask = /*#__PURE__*/React.memo(function (_ref) {
  ...
  var _animatedLineDimension = function _animatedLineDimension(dimension, outerDimension) {
    ...
    var outer = (_outerBoundingRect$ou = outerBoundingRect == null ? void 0 : outerBoundingRect[outerDimension]) != null ? _outerBoundingRect$ou : 0;
    if (dimension) {
...
var useBarcodeFinder = (function (dataProcessor, onScannedData, customBarcodeRead) {
  ...
  if (!customBarcodeRead || customBarcodeRead && typeof customBarcodeRead === 'number') {
    ...
    processingReadBarcode = function processingReadBarcode(data) {
      customBarcodeRead == null ? void 0 : customBarcodeRead.beforeScan == null ? void 0 : customBarcodeRead.beforeScan();
      onScannedData(dataProcessor(data));
      customBarcodeRead == null ? void 0 : customBarcodeRead.afterScan == null ? void 0 : customBarcodeRead.afterScan();
    };
  }
  return {
...
var useInternalBarcodeReadAndroid = function useInternalBarcodeReadAndroid(barcodeRead, isFocused, finderX, finderY, finderWidth, finderHeight, processingReadBarcode) {
  return React.useCallback(function (event) {
     ...
     *  1 --------------- 3
     */
    if (event.type === fleetbackReactNativeCamera.RNCamera.Constants.BarCodeType.pdf417) {
     ...
     *  1 ------ 0
     */
    if (event.type === fleetbackReactNativeCamera.RNCamera.Constants.BarCodeType.qr) {
